...
- MVP shell chrome smoke for wallpaper, panel status indicators, NetworkManager/PipeWire status integration, workspace indicator, launcher targets, and app switcher entries.
