...
require_line packaging/debian/fastgui-dev-tools.install "usr/lib/backlit/dev-tools/verify-parallels-post-repair-readiness.sh"
require_line packaging/debian/fastgui-dev-tools.install "usr/lib/backlit/dev-tools/verify-parallels-mvp-e2e.sh"
