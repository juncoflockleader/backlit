...
require_line "$shell_service" "ExecStart=/usr/bin/backlit-shell --component=all --socket=backlit-0 --serve"
...
require_line "$notification_service" "ExecStart=/usr/bin/backlit-notification-daemon --serve"
...
require_line "$settings_service" "ExecStart=/usr/bin/backlit-settings-daemon --serve"
