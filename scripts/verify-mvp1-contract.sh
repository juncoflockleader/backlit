...
require_contains scripts/verify-smithay-compositor-runtime.sh '"smithay_real_client_input": true'
require_contains scripts/verify-smithay-compositor-runtime.sh '"smithay_real_pointer_input": true'
require_contains scripts/verify-smithay-compositor-runtime.sh '"smithay_real_keyboard_input": true'
require_contains scripts/verify-smithay-compositor-runtime.sh '"smithay_real_input_focus_routing": true'
require_contains scripts/verify-smithay-compositor-runtime.sh '"smithay_shortcut_filter_preserved": true'
...
if [ -n "$artifact_root" ] && [ -d "$artifact_root" ]; then
  ...
  require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_client_input":'
  require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_pointer_input":'
  require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_keyboard_input":'
  require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_input_focus_routing":'
  require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_shortcut_filter_preserved":'
  ...
  if grep '"checked": true' "$artifact_root/smithay-compositor-runtime/manifest.json" >/dev/null; then
    if grep '"drm_launch_ready": true' "$artifact_root/smithay-compositor-runtime/manifest.json" >/dev/null; then
      ...
      require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_client_input": true'
      require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_pointer_input": true'
      require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_keyboard_input": true'
      require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_real_input_focus_routing": true'
      require_contains "$artifact_root/smithay-compositor-runtime/manifest.json" '"smithay_shortcut_filter_preserved": true'
