...
require_contains "$host_dpkg_install_log" 'fastgui-core'
require_contains "$host_dpkg_install_log" 'fastgui-session'
require_contains "$host_dpkg_purge_log" 'fastgui-core'
require_contains "$host_dpkg_purge_log" 'fastgui-session'
