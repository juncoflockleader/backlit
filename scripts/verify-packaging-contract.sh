...
require_line packaging/systemd/backlit-shell.service "ExecStart=/usr/bin/backlit-shell --component=all --socket=backlit-0 --serve"
...
require_line packaging/systemd/backlit-notification-daemon.service "ExecStart=/usr/bin/backlit-notification-daemon --serve"
...
require_line packaging/systemd/backlit-settings-daemon.service "ExecStart=/usr/bin/backlit-settings-daemon --serve"
